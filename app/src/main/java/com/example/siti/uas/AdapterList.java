...
public class AdapterList extends
    ...
    public AdapterList(MainActivity mainActivity,
                       ArrayList<HashMap<String, String>> list_data) {
    ...
    public void onBindViewHolder(ViewHolder holder, int position)
    {
        Picasso.with (context)
                .load("http://sasmitoh.nitarahmawati.my.id/getdata.php" +
                        list_data.get(position).get("image_path"))
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView) {
            super(itemView);
            txtnim = (TextView)
                    itemView.findViewById(R.id.txtnim );
            txtname = (TextView)
                    itemView.findViewById(R.id.txtname );
            txtnohp = (TextView)
                    itemView.findViewById(R.id.txtnohp );
            txttgl_lahir = (TextView)
                    itemView.findViewById(R.id.txttgl_lahir );
            imgdata = (ImageView)
                    itemView.findViewById(R.id.imgdata );
        }
    }
}